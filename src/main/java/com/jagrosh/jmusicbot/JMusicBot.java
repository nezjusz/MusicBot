...
public class JMusicBot 
{
    ...
    public final static Permission[] RECOMMENDED_PERMS = {Permission.VIEW_CHANNEL, Permission.MESSAGE_SEND, Permission.MESSAGE_ADD_REACTION,
    ...
    private static void startBot()
    {
        ...
        try
        {
            JDA jda = JDABuilder.create(config.getToken(), Arrays.asList(INTENTS))
                    ...
                    .setStatus(config.getStatus()==OnlineStatus.INVISIBLE
                            ? OnlineStatus.INVISIBLE : OnlineStatus.DO_NOT_DISTURB)
                    // DAVE (Discord Audio & Video End-to-End Encryption) is required for voice from JDA 6.3.0+.
                    // JDAVE provides the DaveSessionFactory implementation (wraps Discord's official libdave).
